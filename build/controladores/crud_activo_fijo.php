...
if(!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') 
{
    ...
    if($bandera=="add"){
        ...
        function obtenerResultado(){
          ...
          $stmt = $pdo->prepare("SELECT MAX(id_empleado)+1 AS 'id' FROM prueba");
          $stmt->execute();
          ...
          $stmt=$pdo->prepare("INSERT INTO prueba (id_empleado, nombre, apellido, dui, nit, fecha_nac, genero, puesto, direccion, correo, telefono, fecha_ingreso, estado, id_usuario) VALUES (:id_empleado, :nombre, :apellido, :dui, :nit, :fecha_nac, :genero, :puesto, :direccion, :correo, :telefono, :fecha_ingreso, :estado, :id_usuario)");
