...
$nivel_usu=$_SESSION['nivel'];*/
  ...
  if(isset($_POST['id'])){
   ...
   // $id_activo_fijo=1;
    ...
    $stmt= $pdo->prepare("SELECT codigo, descripcion, observacion, calidad, marca, modelo, num_serie, lote, DATE_FORMAT(fecha_adquisicion, '%d/%m/%Y') AS fecha_adquisicion, financiamiento, valor_adquisicion, valor_estimado, valor_residual, vida_util, doc_adquisicion, id_categoria, id_subcategoria, id_proveedor FROM activo_fijo WHERE id_activo_fijo=:id_activo_fijo");
