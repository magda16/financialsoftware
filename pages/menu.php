    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../pages/empleado/empleado_add.php"><i class="fa fa-circle-o"></i> Agregar</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../../pages/cliente/cliente_list.php"><i class="fa fa-wrench"></i> Mantenimiento</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="../../pages/sucursal/sucursal_list.php"><i class="fa fa-wrench"></i> Mantenimiento</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
