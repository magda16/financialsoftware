        ...
        <div class="col-md-6">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Datos Categoría</h3>
            </div>
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="control-label" for="tipo"><i class="ic"></i> Tipo Según Ley</label>
            ...
            <div class="box-footer" align="right">
              <button type="button" id="btnguardar" name="btnguardar" class="btn btn-round btn-success">
                <span class="fa fa-floppy-o">&nbsp;&nbsp;&nbsp;</span>Guardar Categoría
              </button>
                        
              <button type="button" class="btn btn-round btn-default" onclick="location.href='../../pages/catalogo_activos/catalogo_categoria_add.php'">
