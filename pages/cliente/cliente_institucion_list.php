        ...
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Lista de Clientes Instituciones</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <form id="from_cliente_edit" name="from_cliente_edit" action="cliente_edit.php" method="POST">
                <input type="hidden" id="id" name="id">
                <input type="hidden" id="tipo" name="tipo" value="Institucion">
              </form>
